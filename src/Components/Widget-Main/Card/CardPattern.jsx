...
return (
  <Card>
    <CardBody>
      ...
      >Update new elementsUpdate new elementsUpdate new Update new elemenUpdate new elementsts new elementse new elementsUpdate new elementsUpdate new elementsUpdate new elements
        <TextCopy
          onClick={() => {
